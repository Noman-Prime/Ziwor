            ...
            <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-4 sm:px-6 lg:h-[72px] lg:px-8 xl:h-20">
                    ...
                    {menuItems.map(
                        ({
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 whitespace-nowrap rounded-full border border-[#EADCE2] bg-[#FCF7F9] px-3.5 py-2.5 text-[13px] font-semibold text-[#2A2024] transition duration-300 hover:border-[#7A1E3A] hover:bg-[#7A1E3A] hover:text-white xl:px-4 xl:text-sm"
                            >
                ...
                <div className="flex items-center gap-1 sm:gap-2 lg:gap-3">
                        ...
                        >
                            ...
                            >
                                <input
                                    ...
                                    autoComplete="off"
                                    className="h-11 min-w-0 flex-1 rounded-xl border border-[#E8D8DF] bg-[#FCF7F9] px-4 text-sm text-[#2A2024] outline-none transition placeholder:text-[#9A858E] focus:border-[#7A1E3A] focus:ring-2 focus:ring-[#7A1E3A]/10"
                                />
                                ...
                                <button
                                    ...
                                    aria-label={t("search")}
                                    className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#7A1E3A] text-xl text-white transition hover:bg-[#5E1730] disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    <IoSearch />
                                </button>
                            </form>
                    ...
                    <button
                        ...
                        className="relative flex h-10 w-10 items-center justify-center rounded-full text-[23px] text-[#222] transition hover:bg-[#F8EDF1] hover:text-[#7A1E3A] sm:text-[25px]"
                    >
                        <FiShoppingCart />

                        <span className="absolute right-0 top-0 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-[#C79A2B] px-1 text-[10px] font-bold leading-none text-white">
                            {cartCount > 99
                                ? "99+"
                                : cartCount}
                        </span>
                    ...
                    >
                        ...
                        >
                            <div className="mb-3 border-b border-[#EADCE2] px-2 pb-3">
                                ...
                                <p className="mt-1 text-xs leading-5 text-[#8F7882]">
                                    {t(
                                        "accountDescription"
                                    )}
                                </p>
                            ...
                            <button
                                ...
                                className="flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#731D46] px-4 py-3 text-sm font-bold text-white transition duration-300 hover:bg-[#D4A037]"
                            >
                                <FiLogIn size={17} />
                            ...
                            <button
                                ...
                                className="mt-2 flex min-h-11 w-full items-center justify-center gap-2 rounded-xl border border-[#731D46] bg-white px-4 py-3 text-sm font-bold text-[#731D46] transition duration-300 hover:bg-[#F8EDF1]"
                            >
                                <FiUserPlus size={17} />
            ...
            >
                <div className="flex flex-col gap-3 px-4 py-5 sm:px-6">
                    {menuItems.map(
                        ({
                            ...
                            <button
                                ...
                                className="group flex w-full items-center gap-4 rounded-2xl border border-[#E8D8DF] bg-[#FCF7F9] px-4 py-4 text-[#2A2024] transition duration-300 hover:border-[#7A1E3A] hover:bg-[#7A1E3A] hover:text-white active:scale-[0.98]"
                            >
                                ...
                                <span className="text-start text-[15px] font-bold">
                                    {title}
                                </span>
                            </button>
                        )
                    ...
                    <div className="mt-2 border-t border-[#EADCE2] pt-5">
                        <p className="mb-3 text-center text-xs font-semibold uppercase tracking-[0.15em] text-[#9A7686]">
                            {t("language")}
                        </p>
