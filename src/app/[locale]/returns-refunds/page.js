            ...
            >
                <section className="relative overflow-hidden bg-[#731D46]">
                    ...
                    <div className="relative mx-auto flex min-h-[270px] w-full max-w-[1440px] flex-col items-center justify-center px-4 py-14 text-center sm:min-h-[320px] sm:px-6 md:px-8 lg:min-h-[360px] lg:px-10 xl:px-12">
                        ...
                        <h1 className="mt-5 max-w-4xl text-[36px] font-black leading-tight tracking-[-0.035em] text-white sm:text-[46px] md:text-[56px] lg:text-[64px]">
                            {t("title")}
                        </h1>
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-10 lg:grid-cols-4 lg:gap-6">
                            {policyItems.map((item) => {
                                ...
                                return (
                                    <article
                                        key={item.id}
                                        className="rounded-2xl border border-[#E8DDE1] bg-white p-5 shadow-sm transition duration-300 md:hover:-translate-y-1 md:hover:border-[#D4A037]/60 md:hover:shadow-lg"
                                    >
                                        ...
                                        <h3 className="mt-4 text-lg font-black text-[#2B1D1D]">
                                            {item.title}
                                        </h3>
                            ...
                            <div>
                                ...
                                <div className="mt-6 rounded-2xl border border-[#D4A037]/20 bg-[#D4A037]/5 p-5">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-base font-black text-[#2B1D1D]">
                                                {t("steps.note.title")}
                                            </h3>

                                            <p className="mt-1 text-sm leading-6 text-[#74666A]">
                                                {t(
                                                    "steps.note.description"
                                                )}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                {steps.map((item) => {
                                    ...
                                    return (
                                        <article
                                            key={item.id}
                                            className="relative overflow-hidden rounded-2xl border border-[#E8DDE1] bg-[#FCFAFB] p-5"
                                        >
                                            <span
                                                aria-hidden="true"
                                                className="absolute end-4 top-3 text-4xl font-black text-[#731D46]/5"
                                            >
                                                {item.number}
                                            </span>
                ...
                <section className="w-full py-10 sm:py-12 md:py-14 lg:py-20">
                    <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 gap-6 px-4 sm:px-6 md:px-8 lg:grid-cols-2">
                        <article className="rounded-3xl border border-green-200 bg-white p-5 shadow-sm sm:p-7">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xs font-bold uppercase tracking-[0.1em] text-green-600">
                                        {t(
                                            "eligibility.accepted.badge"
                                        )}
                                    </span>

                                    <h2 className="mt-1 text-xl font-black text-[#2B1D1D]">
                                        {t(
                                            "eligibility.accepted.title"
                                        )}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 space-y-4">
                                {eligibleItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-sm leading-6 text-[#74666A]">
                                            {item.text}
                                        </p>
                                    </div>
                                ))}
                        ...
                        <article className="rounded-3xl border border-red-200 bg-white p-5 shadow-sm sm:p-7">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xs font-bold uppercase tracking-[0.1em] text-red-500">
                                        {t(
                                            "eligibility.excluded.badge"
                                        )}
                                    </span>

                                    <h2 className="mt-1 text-xl font-black text-[#2B1D1D]">
                                        {t(
                                            "eligibility.excluded.title"
                                        )}
                                    </h2>
                                </div>
                            </div>
                ...
                <section className="w-full bg-white py-10 sm:py-12 md:py-14 lg:py-20">
                    <div className="mx-auto w-full max-w-[1000px] px-4 sm:px-6 md:px-8">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <h2 className="mt-4 text-[30px] font-black leading-tight text-[#2B1D1D] sm:text-[38px] lg:text-[46px]">
                                {t("faq.title")}
                            </h2>
                        ...
                        <div className="mt-8 space-y-3">
                            {questions.map((item) => {
                                ...
                                return (
                                    <article
                                        key={item.id}
                                        className="overflow-hidden rounded-2xl border border-[#E8DDE1] bg-[#FCFAFB]"
                                    >
                                        <h3>
                                            <button
                                                id={buttonId}
                                                ...
                                                className="flex w-full items-center justify-between gap-4 px-4 py-4 text-start transition duration-300 hover:bg-[#F8F0F3] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#731D46] sm:px-5 sm:py-5"
                                            >
                                                <span className="text-sm font-extrabold text-[#2B1D1D] sm:text-base">
                                                    {item.question}
                                                </span>
                                                ...
                                                <ChevronDown
                                                    aria-hidden="true"
                                                    size={19}
                                                    className={`shrink-0 text-[#731D46] transition duration-300 ${isActive
                                                            ? "rotate-180"
                                                            : ""
                                                        }`}
                                                />
                                        ...
                                        >
                                            <div className="overflow-hidden">
                                                <p className="border-t border-[#E8DDE1] px-4 py-4 text-sm leading-6 text-[#74666A] sm:px-5">
                                                    {item.answer}
                                                </p>
                                            </div>
                                        </div>
                ...
                <section className="w-full py-10 sm:py-12 lg:py-16">
                    <div className="mx-auto w-full max-w-[1100px] px-4 sm:px-6 md:px-8">
                        <div className="rounded-3xl bg-[#731D46] px-5 py-8 text-center sm:px-8 sm:py-10 lg:px-12">
                            ...
                            <h2 className="mt-5 text-[27px] font-black leading-tight text-white sm:text-[34px]">
                                {t("cta.title")}
                            </h2>
                            ...
                            <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
                                <Link
                                    href="/contact"
                                    className="inline-flex min-h-12 items-center justify-center rounded-xl bg-[#D4A037] px-6 py-3 text-sm font-bold text-white transition duration-300 hover:bg-[#E0AD43] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#731D46] md:hover:-translate-y-0.5"
                                >
                                    {t("cta.contact")}
                                </Link>
                                ...
                                <Link
                                    href="/track-order"
                                    className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-white/30 bg-white/5 px-6 py-3 text-sm font-bold text-white transition duration-300 hover:bg-white hover:text-[#731D46] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#731D46]"
                                >
